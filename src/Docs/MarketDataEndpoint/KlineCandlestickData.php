 ...
 */
readonly class KlineCandlestickData implements Endpoint, HasQueryParameters, ProcessResponse
{
    public const METHOD = 'klines';

    public function __construct(
        public string $endpoint = '/api/v3/klines',
    ...
    public function getQuery(
        ...
        if (! $symbol) {
            throw new EndpointQueryException('Symbol is mandatory parameter: https://binance-docs.github.io/apidocs/spot/en/#kline-candlestick-data');
        }

        if (! $interval) {
            throw new EndpointQueryException('Interval is mandatory parameter: https://binance-docs.github.io/apidocs/spot/en/#kline-candlestick-data');
        }
